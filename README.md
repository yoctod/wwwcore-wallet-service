...
A Multisig HD Wwwcore Wallet Service. fork from bitcore-wallet-service
...
# Getting Started
```
 git clone https://github.com/yoctod/wwwcore-wallet-service.git
 cd wwwcore-wallet-service
 npm install
 npm start
```
...
BWS supports SSL and Clustering. For a detailed guide on installing BWS with extra features see [Installing BWS](https://github.com/yoctod/wwwcore-wallet-service/blob/master/installation.md). 
